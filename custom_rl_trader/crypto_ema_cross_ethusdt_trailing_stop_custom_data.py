...
if __name__ == "__main__":
    ...
    tick_data = CSVTickDataLoader.load("dataset/binance/futures/BTCUSDT-trades-2024-06-29.csv",'time')

    tick_data.columns = ['trade_id', 'price', 'quantity', 'quote_qty', 'buyer_maker']
